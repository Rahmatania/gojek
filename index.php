...
<html>
	<head>
		...
		<ul class="nav navbar-naav>
			<li>
		<a href="#"id=""> <span class="glyphicon glyphicon-envelope"></span>
		Notification</a>
			</li>
		<li class="dropdown">
	...
	<li class="dropdown">
	<a href="#"
	class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span> Settings<strong class="caret"></strong></a>
			<ul class="dropdown-menu">
			<li>
		<a href="#" id="suNav"><span classs="glyphicon glyphicon-wrench"></span> Umum</a>
				</li>
				<li>
				<a href="#" id="smNav"><span class="glyphicon glyphicon-map-maker"></span> Maps</a>
				</li>
			</ul>
		</li>
	</ul>
...
<div id="semua" class="container-fluid">
	<div class="row">
						...
						<ul class="nav nav-tabs">
							<li class="active">
								...
								<b> Info Lokasi Mobil, Posisi Anda Yang Paling Dibawah</b>
									...
									<select id="infoLokasi" class="form-control" size="5">
								</select>
									</div>
									<div class="tab-pane" id="panelInfoUser"></br>
									<input type="text" class="from-control" id="userPengguna" value="<?php echo $pengguna; ?>" readOnly/>
		...
		<div class="modal fade" id="modalPenunjuk" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="ststic" data-keyboard="true">
...
<div class="modal fade" id="settingMaps" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="true">
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-danger" data-sismiss="modal">
